...
1. **Overall Program:** Takes a graph, number of vehicles, and where they start and are going to calculate aspects of the traffic network, namely the nash equilibrium and social optimum. Requires all inputs to be read in-order (as specified above in 3.). Conducts error checking for inputs and calls all other functions. A lot of code is reused from projects 1 and 2.
2. **MAIN - traffic_analysis.py:**
